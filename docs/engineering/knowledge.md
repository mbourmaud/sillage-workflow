...
Task stores retain operational history. Repositories retain knowledge needed by
future work.
...
plans, verification logs, screenshots, or task histories. Git history is not a
reason to keep obsolete pages in the active navigation surface.
